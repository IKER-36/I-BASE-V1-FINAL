...
RegisterCommand("voz_key_proximidad", function()
	local playerData = voiceData[playerServerId]
	local playerMode = 2
	...
	if mumbleConfig.controls.speaker.key == mumbleConfig.controls.proximity.key and not (mumbleConfig.controls.speaker.secondary == nil) then
...
RegisterKeyMapping("voz_key_proximidad","Cambiar proximidad de la voz","keyboard","Z")
