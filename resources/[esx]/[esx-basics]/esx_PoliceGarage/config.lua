...
Config.CarDraw3DText = "Pulsa [E] para abrir el garaje."			-- set your desired text here
...
Config.HeliDraw3DText = "Pulsa [E] para abrir el garaje.."		-- set your desired text here
...
Config.BoatDraw3DText = "Pulsa [E] para abrir el garaje."		-- set your desired text here


-- Police Cars:
Config.PoliceVehicles = {
		{ model = '', label = '----- LSPD -----'},
		{ model = 'police', label = 'Patrulla 1'},
...
Config.PoliceHelicopters = {
	{ model = 'polmav', label = 'Politie Helicopter', livery = 0, price = 0 }
}
...
-- Commands:
Config.RepairCommand = 'arreglado'
Config.CleanCommand = 'limpiar'

-- Menu Labels & Titles:
Config.LabelStoreVeh = "Coloque el vehículo en el garaje"
Config.LabelGetVeh = "Toma un vehículo de servicio"
Config.LabelPrimaryCol = "Primario"
Config.LabelSecondaryCol = "Secundario"
Config.LabelExtra = "Extra"
Config.LabelLivery = "Pintura"
Config.TitlePoliceGarage = "Garaje LSPD"
