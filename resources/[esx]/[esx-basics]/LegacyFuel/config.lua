...
Config.Strings = {
	...
	EToRefuel = "Presiona ~g~E ~w~para poner gasolina",
	JerryCanEmpty = "Esta vacio",
	FullTank = "Deposito lleno",
	PurchaseJerryCan = "Presiona ~g~E ~w~para comprar un barril por ~g~$" .. Config.JerryCanCost,
	CancelFuelingPump = "Presiona ~g~E ~w~para cancelar el repostaje",
	CancelFuelingJerryCan = "Presiona ~g~E ~w~para cancelar repostaje",
	NotEnoughCash = "No hay suficiente efectivo",
	RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el barril ",
	NotEnoughCashJerryCan = "Dinero insuficiente",
	JerryCanFull = "Deposito Lleno",
	TotalCost = "Precio",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para cojer el barril"
	Config.Strings.RefillJerryCan = "Presiona ~g~E ~w~ para refilar el deposito"
end
