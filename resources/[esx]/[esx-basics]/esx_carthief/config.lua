...
Config.Delivery = {
	...
	Delivery1 = {
		...
		Type  = 1,
		Payment  = 2500,
		Cars = {'reaper','italigtb','pfister811'},
	},
	--Lighthouse 9.61KM
	Delivery4 = {
		...
		Type  = 1,
		Payment  = 4000,
		Cars = {'osiris','cyclone','ruston','turismor'},
	},
	...
	Delivery13 = {
		...
		Type  = 1,
		Payment  = 3000,
		Cars = {'specter','comet5','sc1','banshee2'},
	},
}
