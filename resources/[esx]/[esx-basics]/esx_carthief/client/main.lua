			...
			if isActive == 0 then
				ESX.TriggerServerCallback('esx_carthief:anycops', function(anycops)
					if anycops >= Config.CopsRequired then
						...
						TriggerServerEvent('esx_carthief:registerActivitym', 1)
						TriggerServerEvent('esx_carthief:registerActivityg', 1)
						TriggerServerEvent('esx_carthief:registerActivityb', 1)
...
function FinishDelivery()
  if(GetVehiclePedIsIn(GetPlayerPed(-1), false) == car) and GetEntitySpeed(car) < 3 then
    ...
    --Pay the poor fella
		...
		TriggerServerEvent('esx_carthief:registerActivitym', 0)
		TriggerServerEvent('esx_carthief:registerActivityb', 0)
		TriggerServerEvent('esx_carthief:registerActivityg', 0)
    --For delivery blip
    isTaken = 0
	...
	TriggerServerEvent('esx_carthief:stopalertcopsm')
	TriggerServerEvent('esx_carthief:stopalertcopsg')
	TriggerServerEvent('esx_carthief:stopalertcopsb')	
  else
...
Citizen.CreateThread(function()
  while true do
    ...
    if isTaken == 1 and IsPedInAnyVehicle(GetPlayerPed(-1)) then
	  ...
	  TriggerServerEvent('esx_carthief:alertcopsm', coords.x, coords.y, coords.z)
