...
RegisterServerEvent('esx_carthief:registerActivitym')
AddEventHandler('esx_carthief:registerActivitym', function(value)
	activity = value
	if value == 1 then
		activitySource = source
		--Send notification to cops
...
RegisterServerEvent('esx_carthief:registerActivityg')
AddEventHandler('esx_carthief:registerActivityg', function(value)
	activity = value
	if value == 1 then
		activitySource = source
		--Send notification to cops
...
RegisterServerEvent('esx_carthief:registerActivityb')
AddEventHandler('esx_carthief:registerActivityb', function(value)
	activity = value
	if value == 1 then
		activitySource = source
		--Send notification to cops
...
RegisterServerEvent('esx_carthief:alertcopsm')
AddEventHandler('esx_carthief:alertcopsm', function(cx,cy,cz)
	local source = source
...
RegisterServerEvent('esx_carthief:stopalertcopsm')
AddEventHandler('esx_carthief:stopalertcopsm', function()
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	local xPlayers = ESX.GetPlayers()
...
RegisterServerEvent('esx_carthief:stopalertcopsg')
AddEventHandler('esx_carthief:stopalertcopsg', function()
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	local xPlayers = ESX.GetPlayers()
...
RegisterServerEvent('esx_carthief:stopalertcopsb')
AddEventHandler('esx_carthief:stopalertcopsb', function()
	local source = source
	local xPlayer = ESX.GetPlayerFromId(source)
	local xPlayers = ESX.GetPlayers()
